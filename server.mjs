...
function renderStoreDirectory(template, stores) {
  ...
  const highlights = products ? `<section class="store-directory__highlights" aria-labelledby="directory-products-heading"><div class="store-directory__section-head"><div><h2 id="directory-products-heading">Midagi, mis jääb silma</h2><p class="store-directory__highlights-intro">Valik tooteid Eesti e-poodidest.</p></div></div><div class="store-directory__product-grid">${products}</div></section>` : ''
