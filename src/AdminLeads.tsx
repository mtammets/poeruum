      ...
      <div className="admin-leads__workspace">
        ...
        {selected && draft ? <article className="admin-leads__detail">
          ...
          <form onSubmit={(event) => { event.preventDefault(); void saveLead() }}>
            ...
            <small className="admin-leads__policy">Saata saab ainult ettevõtte veebidomeeniga seotud avalikule üldpostkastile. Süsteem lisab saatja andmed, kontakti allika, privaatsus- ja ühe klõpsuga loobumislingi.</small>
